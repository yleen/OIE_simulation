...
def complete_sequential_addition(p_oieS: OIES,
    ...
    Args:
        ...
        p_domain_filtering_2tuple(_2Tuple): A domain filter 2Tuple instance
    ...
    F: TwoTupleTS = f_domain_filtered_2tupleTS(feasible_2tupleTS,
                                               p_domain_filtering_2tuple[0],
                                               p_domain_filtering_2tuple[1])
    if F.empty():
        print_finish_line()
        return VoidOIE()
