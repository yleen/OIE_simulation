...
def check_void_condition_validation(p_oieS: OIES) -> bool:
    # (Property 11) Sequence operations involving identical OIE instances result in a void OIE instance
    ...
    if p_oieS.has_intersection_of_atomEventEstarS():
        ...
        return False
    # (Property 12) The sequence operations involving void OIE instances result oie_void
