...
from simulation.sequential_operation.helper import get_2tuple_from_2tupleTS
...
def test_2TupleTS():
    ...
    _2tuple_11 = get_2tuple_from_2tupleTS(_2tuple_TS, 1, 1)
    print(_2tuple_11)
    _2tuple_22 = get_2tuple_from_2tupleTS(_2tuple_TS, 2, 2)
    print(_2tuple_22)
    _2tuple_33 = get_2tuple_from_2tupleTS(_2tuple_TS, 3, 3)
    print(_2tuple_33)
    _2tuple_36 = get_2tuple_from_2tupleTS(_2tuple_TS, 3, 6)
    print(_2tuple_36)
